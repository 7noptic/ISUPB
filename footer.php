...
<footer class="footer">
    ...
    <section class="footer-content">
        ...
        <nav class="footer-content__item">
            ...
            <ul class="footer-content__list">
                <li class="footer-content__elemlist">Круглосуточная поддержка</li>
                ...
                <li class="footer-content__elemlist">
                    <a href="#" class="footer-content__link"><span><?php the_field( 'adres', 'option' ); ?></span></a>
                </li>
            </ul>
        </nav>
        <nav class="footer-content__item">
            ...
            <ul class="footer-content__list">
                <li class="footer-content__elemlist">Лицензия <?php the_field( 'liczenziya', 'option' ); ?></li>
                <li class="footer-content__elemlist">
