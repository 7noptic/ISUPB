    ...
    <section class="about-modules">
        <div class="about-modules__wrapper">
            ...
            <div class="about-modules__img">
                ...
                <div class="about-modules__img-hexagon">	 <?php the_post_thumbnail( array( 140, 140 ) ); ?>			</div>
            </div>
        </div>
    </section>
                        ...
                        <div class="swiper-wrapper">
							...
							<?php while ( have_rows( 'modul_-_taby' ) ): the_row();
                                ...
                                <div class="swiper-slide">
                                    <a href="#" class="characteristic"><?php echo $nazvanie_taba; ?></a></div>
        ...
        <section class="text2column">
			...
			<?php while ( have_rows( 'modul_-_taby' ) ): the_row();
                ...
                <div class="text2column__block">
                    <div class="text2column__left text-paragraph"><?php echo $tekst_taba; ?></div>
                    <div class="text2column__right">
                        <div class="text2column__img">
                            <div class=""><img src="<?php echo $izobrazhenie_taba['url']; ?>"
                                               alt="<?php echo $izobrazhenie_taba['alt'] ?>"/></div>
                            <div class=""><img src="<?php echo $izobrazhenie2_taba['url']; ?>"
                                               alt="<?php echo $izobrazhenie2_taba['alt'] ?>"/></div>
                        </div>
                    </div>
                </div>
